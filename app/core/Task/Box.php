...
class Box extends Task
{
    protected function _getInfo() {
        ...
        if ($activityInfo['activity_max'] > $activityReceiveInfo['count']) {
            ...
            $return = array('count' => $activityReceiveInfo['count'] + 1, 'num' => rand($awardRange['award_min'], $awardRange['award_max']),'type' => 'box', 'receiveTime' => (($activityReceiveInfo['maxTime'] ? strtotime($activityReceiveInfo['maxTime']) : time()) + $activityInfo['activity_duration'] * 60) * 1000);
        }
